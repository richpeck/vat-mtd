...
require_relative 'app/controllers/application' # => Moved application into "controllers" directory, mainly to give us modularity with the way in which the app is able to work
