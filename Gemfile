...
gem 'rake', '~> 13.0', '>= 13.0.1'                              # => Allows for Rake usage
...
gem 'activerecord', '~> 6.0', '>= 6.0.3.3' # => Allows us to use AR 6.0.0.rc1+ as opposed to 5.2.x (will need to keep up to date)
...
gem 'humanize', '~> 2.4', '>= 2.4.3'  # => Humanize (allows us to translate numbers to words)
